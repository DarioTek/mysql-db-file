...
select * from DAILY_NET_BALANCE WHERE date(RECORD_DATE) = CURDATE();

select MAX(RECORD_DATE) from DAILY_NET_BALANCE WHERE date(RECORD_DATE) = CURDATE()
GROUP BY date(RECORD_DATE);

select MIN(RECORD_DATE) from DAILY_NET_BALANCE WHERE date(RECORD_DATE) = CURDATE()
GROUP BY date(RECORD_DATE);
