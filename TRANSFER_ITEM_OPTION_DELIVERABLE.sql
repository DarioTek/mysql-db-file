...
SELECT COUNT(ACTIVITY_ID) FROM TRANSFER_ITEM_OPTION_DELIVERABLE;

SELECT COUNT(DISTINCT(ACTIVITY_ID)) FROM TRANSFER_ITEM_OPTION_DELIVERABLE;
...
SELECT * FROM TRANSFER_ITEM_OPTION_DELIVERABLE WHERE ACTIVITY_ID IN (
SELECT T.ACTIVITY_ID
FROM TRANSFER_ITEM T
LEFT JOIN TRANSFER_ITEM_OPTION_DELIVERABLE D ON T.ACTIVITY_ID = D.ACTIVITY_ID
WHERE D.ACTIVITY_ID IS NULL);
